...
function ChatSidebar() {
  ...
  const handleOpenAddUser = () => {
    // Load requests whenever the modal opens.
    getContactRequests();
    setShowAddUser(true);
  };
        ...
        >
          ...
          <Tabs.ListContainer className="shrink-0 border-b border-border px-2 pb-2 pt-1">
            <Tabs.List className="w-full gap-0.5">
              ...
              >
                <MessageSquareIcon className="size-3.5 opacity-80" />
                Chats
              </Tabs.Tab>
          ...
          >
            ...
            <div className="p-2">
              <button
                ...
                className="flex w-full items-center justify-center gap-2 rounded-xl border border-border px-3 py-2.5 text-sm font-medium transition hover:bg-muted/10"
              >
